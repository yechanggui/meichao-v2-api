...
class StoreCoupon extends AuthController
{
    ...
    public function create()
    {
        ...
        return $this->success($this->service->createForm($type));
    }
    ...
    {
        return $this->success($this->service->createIssue($id));
    }
    ...
    public function update_issue($id)
    {
        ...
        $this->service->upIssue($id, $_id, $coupon_title, $rangeTime, $count, $status, $is_permanent, $full_reduction, $is_give_subscribe, $is_full_give, $is_type);
