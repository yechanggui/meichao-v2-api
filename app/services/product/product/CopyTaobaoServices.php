...
class CopyTaobaoServices extends BaseServices
{
    ...
    public function save(array $data)
    {
        ...
        //开始图片下载处理
        $this->transaction(function () use ($attrs, $detail, $data, $AttachmentCategory, $storeProductServices, $storeDescriptionServices, $storeProductCateServices, $storeProductAttrServices, $storeProductCouponServices) {
            //放入主图
            $images = [
